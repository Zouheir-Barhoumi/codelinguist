<template>
  <section class="py-10 relative" :class="bgColor">
    ...
    >
      <h2
        class="font-sans inline-block bg-light text-h2 2xl:text-4xl font-bold mt-1 mb-8 border-b-4 border-l-2 border-r-3 border-dark align-center px-8 py-2 tracking-wider capitalize"
      >
        {{ title }}
      </h2>
